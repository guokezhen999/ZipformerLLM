#!/bin/bash
#SBATCH --job-name=2.ast
#SBATCH --output=logs/slurm/sft_stage2_ast_%j.out
#SBATCH --error=logs/slurm/sft_stage2_ast_%j.err
#SBATCH --gres=gpu:8
#SBATCH --nodes=1
...
ckpt_path="exp/sft_stage2_ast_step_100k/checkpoints/epoch-epoch=13-step-step=90814.ckpt"
