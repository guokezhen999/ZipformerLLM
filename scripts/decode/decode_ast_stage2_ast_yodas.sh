...
checkpoints=(
    # "epoch-epoch=00-step-step=6493.ckpt"
    # "epoch-epoch=01-step-step=12980.ckpt"
    # "epoch-epoch=02-step-step=19465.ckpt"
    # "epoch-epoch=03-step-step=25951.ckpt"
    # "epoch-epoch=04-step-step=32436.ckpt"
    # "epoch-epoch=05-step-step=38914.ckpt"
    "epoch-epoch=06-step-step=45410.ckpt"
    "epoch-epoch=07-step-step=51897.ckpt"
    "epoch-epoch=08-step-step=58381.ckpt"
    "epoch-epoch=09-step-step=64872.ckpt"
    "epoch-epoch=10-step-step=71356.ckpt"
    "epoch-epoch=11-step-step=77834.ckpt"
    "epoch-epoch=12-step-step=84323.ckpt"
    "epoch-epoch=13-step-step=90814.ckpt"
    "epoch-epoch=14-step-step=97301.ckpt"
    # "epoch-epoch=15-step-step=100000.ckpt"
...
for ckpt_name in "${checkpoints[@]}"; do
    tag="${ckpt_name%.ckpt}"
    DECODE_DIR=exp/sft_stage2_ast_step_100k/decode_ast_yodas/${tag}
    CHECKPOINT="exp/sft_stage2_ast_step_100k/checkpoints/${ckpt_name}"
