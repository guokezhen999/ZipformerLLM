...
export SPEECHLLM_AST_LANG_OPTIONS="Chinese,English"
export SPEECHLLM_ASR_LANG_OPTIONS="auto,Chinese,English"
...
export SPEECHLLM_LLM_PATH="pretrained_models/grpo_vllm_kl_0.05_lr_1e-6_comet_step_2000_llm"
# export SPEECHLLM_CHECKPOINT="exp/grpo_vllm_kl_0.05_lr_1e-6_comet_step_2000/checkpoints/step-step=2000.ckpt"
